...
public class RealFuntionDraw extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ComplexMap = new javax.swing.JPanel();
        btnDraw = new javax.swing.JButton();
        pnlDraw1 = new javax.swing.JPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        ComplexMap.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ComplexMapMouseClicked(evt);
            }
        });
        getContentPane().add(ComplexMap, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 300, 300));
        ComplexMap.getAccessibleContext().setAccessibleName("");
        ...
        getContentPane().add(btnDraw, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 150, -1));

        pnlDraw1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pnlDraw1MouseClicked(evt);
            }
        });
        getContentPane().add(pnlDraw1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 300, 300));

        setBounds(0, 0, 688, 557);
    }// </editor-fold>//GEN-END:initComponents

    private void drawAxis(){
        Graphics2D g = (Graphics2D) ComplexMap.getGraphics();
    ...
    private void ComplexMapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ComplexMapMouseClicked
        //drawAxis();
    }//GEN-LAST:event_ComplexMapMouseClicked
    ...
    private void pnlDraw1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlDraw1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_pnlDraw1MouseClicked
    ...
    private javax.swing.JPanel ComplexMap;
    private javax.swing.JButton btnDraw;
    private javax.swing.JPanel pnlDraw1;
